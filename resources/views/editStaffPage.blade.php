...
<body>
    ...
    <div class="form-container">
        <h1>Employee Form</h1>
        {!! Form::open(['url' => '/admin/staffpage/editstaff/submit', 'method' => 'POST', 'files' => true]) !!}
            <div class="form-row">
                <div class="form-group">
                    <label for="msnv">MSNV</label>
                    <input type="text" id="MSVN" name="MSNV" value="{{$staff->MSNV}}" readonly>
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="CCCD" name="CCCD" value="{{$staff->CCCD}}" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="Duty" name="Duty" value="{{$staff->Duty}}" required>
                </div>
                <div class="form-group">
